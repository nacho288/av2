...
var objetoa = new objeto("b");
var objetoa = new objeto("c");
var objetoa = new objeto("d");
var objetoa = new objeto("e");
var objetoa = new objeto("f");
var objetoa = new objeto("g");
var objetoa = new objeto("h");

var objetoa = new objeto("llave");

var pepito = new Array; 

pepito[4] = 1;

console.log(pepito[4]);
